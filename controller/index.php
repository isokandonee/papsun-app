...
if (isset($_POST['token'])) {
    if ($_POST['token'] == $_SESSION['token']) {
        ...
        if ($imageFileType !== "jpg" && $imageFileType !== "png" && $imageFileType !== "jpeg"
            ...
            $insert = mysqli_query($conn, "INSERT INTO user_tb (first_name,last_name,email,password,passport,phone,created_at) 
            VALUES ('$firstname','$lastname','$email','$password','$target_file','$phone','$date')");
            if ($insert) {
